...
src_path = src_path_g_code / "Testfall_6.cnc"
...
print(f"Duration of the G-Code according to the video: ca. 125 s")

# Correction
G_Code_Analyser.set_start_time_and_total_time(0, 125000)
